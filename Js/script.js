//© Rafa - Código libre no comercial
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) :"💖Te Amó, Muchas Gracias, Con Amor, Rafa💖";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-03-04T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-03-04T00:00:00');
